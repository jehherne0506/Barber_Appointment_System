    ...
    return(
        <div className="w-full">
            ...
            <div className="bg-white p-10 flex flex-col lg:flex-row m-[2%] lg:m-[5%] gap-10 lg:gap-16">
                ...
                <form className="w-full lg:w-2/3 flex flex-col sm:flex-row text-gray-400 gap-6 sm:gap-16">
                    <div className="w-full sm:flex-1 flex flex-col gap-6">
                        <div className="w-full text-black">
                            <input className="w-full p-2 border-2 border-gray-200 focus:border-gray-400 outline-none rounded-md" placeholder="Your Name*" type="text" required minLength={2} />
                        </div>
                        <div className="w-full text-black">
                            <input className="w-full p-2 border-2 border-gray-200 focus:border-gray-400 outline-none rounded-md" placeholder="Your Email Address*" type="email" required />
                        </div>
                        <div className="w-full text-black">
                            <input className="w-full p-2 border-2 border-gray-200 focus:border-gray-400 outline-none rounded-md" type='date' min={new Date().toISOString().split("T")[0]} defaultValue={new Date().toISOString().split("T")[0]} required minLength={10} />
                        </div>
                    ...
                    <div className="w-full sm:flex-1 flex flex-col gap-6">
                        <div className="w-full">
                            <select className="w-full text-black p-2 border-2 border-gray-200 focus:border-gray-400 outline-none rounded-md" defaultValue="" required>
                        ...
                        <div className="w-full flex-1">
                            <textarea className="w-full h-full text-black p-2 border-2 border-gray-200 focus:border-gray-400 outline-none rounded-md" placeholder="Your Feedback*" required />
                        </div>
